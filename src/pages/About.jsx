  ...
  return (
    <section className="about w-full h-screen relative p-12 pt-48">
      ...
      <p className="bio text-4xl  sm:text-4xl">
        I’m a full-stack web developer with a diverse background in
        ...
        value both community engagement and clear communication. When I'm not coding, I’m a gaming
        climbing, cooking, or eating pizza.
      </p>
    </section>
  );
}
